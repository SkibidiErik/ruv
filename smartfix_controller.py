...
SUBSYSTEM = "RuV_Ersterkennung"
SUBSYSTEM_FOLDER = "RuV_Ersterkennung"
CATEGORY_OPTIONS = ["Ersterkennung", "KFZ"]
...
class SmartFixController(tb.Window):
    ...
    def _build_ui(self):
        ...
        tb.Label(settings_card, text="Kategorie", font=("Segoe UI", 10, "bold")).grid(row=0, column=0, sticky=W, pady=6, padx=(0, 10))
        tb.Combobox(
            settings_card,
        ...
        tb.Label(settings_card, text="Priorität", font=("Segoe UI", 10, "bold")).grid(row=0, column=2, sticky=W, pady=6, padx=(20, 10))
        tb.Combobox(
            settings_card,
        ...
        tb.Label(settings_card, text="DPI", font=("Segoe UI", 10, "bold")).grid(row=1, column=0, sticky=W, pady=6, padx=(0, 10))
        tb.Entry(
            settings_card,
    ...
    def drop_into_exchange(self):
        ...
        if category not in CATEGORY_OPTIONS:
            messagebox.showwarning("Hinweis", "Bitte eine gültige Kategorie auswählen.")
            return
        ...
        dest_dir = Path(EXCHANGE_BASE) / SUBSYSTEM_FOLDER / stack_id
        ...
        self.log(f"Subsystem: {SUBSYSTEM}")
